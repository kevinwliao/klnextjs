...
export default function Writing() {
  return (
    <div
      id="writing"
      className="flex h-screen snap-start flex-col border-b-4 border-slate-950 px-4 py-32 odd:bg-blue-200 even:bg-white dark:border-slate-50 dark:odd:bg-blue-950 dark:even:bg-slate-900 md:px-24 lg:px-48 xl:px-72 xl:py-24"
    >
      <h1 className="mb-4 inline text-balance text-5xl font-bold uppercase tracking-tight sm:text-6xl md:text-7xl xl:text-8xl">
        Writing <span className="text-3xl sm:text-4xl">& more</span>
      </h1>
      <div className="relative max-w-full grow overflow-scroll overflow-x-visible">
        <div>
          ...
          <LinkPreview url="https://www.nytimes.com/2019/01/15/smarter-living/the-edit-sex-abstinence.html"></LinkPreview>
